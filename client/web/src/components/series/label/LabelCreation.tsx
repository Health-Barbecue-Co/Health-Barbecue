...
export const LabelCreation: React.FC<LabelCreationProps> = (props: LabelCreationProps) => {
  ...
  const [selectedLabelType, setSelectedLabelType] = React.useState<string>('');
  const [inputPredefineValue, setInputPredefineValue] = React.useState<string>('');
  const [listPredefineValue, setListPredefineValue] = React.useState<string[]>([]);
